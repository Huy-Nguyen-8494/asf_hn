	...
	output {
		display myDisplay {
	 	...
	 	display myChart refresh: every(1 #cycles) {
	 		chart "Số trang trại bị nhiễm bệnh" x_label: "Tuần" y_label: "Trang trại" title_font: font('Times New Roman', 36, #bold) label_font: font('Times New Roman', 24, #bold) legend_font: font('Times New Roman', 24) {
	 			data "Trang trại nhỏ" value: vNbInfectedFarms[0] color: #red;
	 			data "Trang trại vừa" value: vNbInfectedFarms[1] color: #orange;
	 			data "Trang trại lớn" value: vNbInfectedFarms[2] color: #blue;
	 			data "Tổng" value: vNbInfectedFarms[0] + vNbInfectedFarms[1] + vNbInfectedFarms[2] color: #black;
	 		}
	 	}
	 	display myChart1 refresh: every(1 #cycles) {
	 		chart "Phần trăm trại bị nhiễm bệnh" x_label: "Tuần" y_label: "%" title_font: font('Times New Roman', 36, #bold) label_font: font('Times New Roman', 24, #bold) legend_font: font('Times New Roman', 24) {
	 			data "Trang trại nhỏ" value: vNbInfectedFarms[0]/vNbFarms[0] color: #red;
	 			data "Trang trại vừa" value: vNbInfectedFarms[1]/vNbFarms[1] color: #orange;
	 			data "Trang trại lớn" value: vNbInfectedFarms[2]/vNbFarms[2] color: #blue;
	 		}
	 	}
	 }
}